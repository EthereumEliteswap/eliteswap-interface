 ...
 */
export class UniswapWrappedTokenInfo extends Token {
...
export type TokenAddressMap = Readonly<{ [chainId in ChainId]: Readonly<{ [tokenAddress: string]: UniswapWrappedTokenInfo }> }>
...
export function listToTokenMap(list: TokenList): TokenAddressMap {
  ...
  const map = list.tokens.reduce<TokenAddressMap>(
    (tokenMap, tokenInfo) => {
      ...
      const token = new UniswapWrappedTokenInfo(tokenInfo, tags)
