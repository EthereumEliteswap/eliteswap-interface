...
import { getEtherscanLink, shortenAddress } from '../../utils/uniswap/index'
...
function TokenWarningCard({ token }: TokenWarningCardProps) {
  ...
  return (
    <Wrapper error={duplicateNameOrSymbol}>
      <AutoRow gap="6px">
        <AutoColumn gap="24px">
          <UniswapCurrencyLogo currency={token} size={'16px'} />
          <div> </div>
        </AutoColumn>
...
export default function UniswapTokenWarningModal({
  isOpen,
  tokens,
  onConfirm
}: {
