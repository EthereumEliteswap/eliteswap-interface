...
const ModalUpper = styled(DataCard)`
  ...
  background: radial-gradient(76.02% 75.41% at 1.84% 0%, #EE682E 0%, #021d43 100%);
`
...
const ConfirmOrLoadingWrapper = styled.div<{ activeBG: boolean }>`
  ...
  background: ${({ activeBG }) =>
    activeBG &&
    'radial-gradient(76.02% 75.41% at 1.84% 0%, rgba(238, 104, 46, 1) 0%, rgba(19, 113, 250, 0.2) 100%), #FFFFFF;'};
`
