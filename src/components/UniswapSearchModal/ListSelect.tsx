...
import { useUniswapFetchListCallback } from '../../hooks/uniswap/useFetchListCallback'
import { useOnClickOutside } from '../../hooks/useOnClickOutside'

import useToggle from '../../hooks/useToggle'
import { AppDispatch, AppState } from '../../state'
import { acceptListUpdate, removeList, selectList } from '../../state/uniswaplists/actions'
import { useSelectedListUrl } from '../../state/uniswaplists/hooks'
import { CloseIcon, ExternalLink, LinkStyledButton, TYPE } from '../../theme'
import listVersionLabel from '../../utils/uniswap/listVersionLabel'
...
export function ListSelect({ onDismiss, onBack }: { onDismiss: () => void; onBack: () => void }) {
  ...
  const fetchList = useUniswapFetchListCallback()
